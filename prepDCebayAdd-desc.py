...
# -2-12-22 - extract all recrods added after Oct21st - to build ebay mip list 
import csv
import io
#
import datetime
...
Oct21str="Tue, 18 Jan 2022 19:26:03 +0000"  # oct 28th 2021
...
with open('products.csv', 'r') as rf:
     ...
     with open('cars-desc.txt', 'w') as wf:
