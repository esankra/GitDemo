...
import io
i=0
with open('/mnt/c/ubuntushare/Bonanza-automation/HRDescUpdate-prop65.csv', 'r') as rf:
     reader = csv.reader(rf, delimiter=',')
     with open('/mnt/c/ubuntushare/Bonanza-automation/HRDescUpdate-prop65NA.txt', 'w') as wf:
