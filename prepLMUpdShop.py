...
p = open('LMUpdPrcShop.csv', 'w')  # once items we want is located in our SKU LIST
                ...
                for line in readerV:
                    ...
                    if skuLEM.lower() == skuInx.lower(): # itemnumber comparison 
                        ...
                        if priceinF != priceV: 
                            ...
                            pChngCtr +=1 
                            chngLog=skuIn+" Listed Price= "+str(priceinF)+" newPrice= "+str(priceV)+" pkSize= "+str(pkSizeI)+" UnitP= "+priceLEMstr+"\n"
