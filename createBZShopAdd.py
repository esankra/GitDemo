# prepare add Benzara to shopify
...
with open('bzCat.txt', 'r') as rf:
     reader = csv.reader(rf, delimiter='\t')
     with open('BzAddShop.csv', 'w') as wf:
          ...
          for line in reader:
              ...
              itemT=line[2]
              itemDescX=line[3]
              b1=line[4]  #bullet point key feature
              b2=line[5]
              b3=line[6]
              itemPrice=line[7]
              img1=line[8]
              ...
              if not img1:
                  ...
                  if img2:
                      ...
                      if img3:
                          ...
                          continue
#                      
              itemDesc=itemDescX+"<p>"+b1+"</p>"+"<p>"+b2+"</p>"+"<p>"+b3+"</p>"
