...
import io
i=0
minQty=75  # chng to 75 on 3/23/22 - 3/8/22 - nancy said 50 sometime means 0 !!!
defQty=1  # to turn on 
              ...
              with open('CWQtyPrc.csv', 'r') as f:   # custom vendor data prepared and shared by shop and wlmt common
                ...
                for line in readerV:
                    ...
                    if skuCSW == skuIn:
                        ...
                        #if priceinF != priceV: 
                        if priceinF < priceV:  # 4/13/22 update price only if it computed price is higher than list price
