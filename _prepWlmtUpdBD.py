...
markupPct=0.45
#
p = open('bbdPrc.csv', 'w') # once items we want is located in our SKU LIST in additon to qty just write the sku and price in this file
...
with open('BD_WLMT_SKU_LIST.txt', 'r') as rf:
     ...
     with open('bbdQty.csv', 'w') as wf:
          ...
          for line in reader:
              ...
              if found == 1:
                 print('Not matched',sku,priceIn,qtyIn)
